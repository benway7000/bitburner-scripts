...
export async function main(ns) {
  ...
  if (mode == "undefined") {
    ...
    ns.tprint("INFO : Usage: run v3.js <mode> <pct>")
    ns.tprint("INFO :")
    ns.tprint("INFO : HACK MODE: run v3.js hack <pct>")
    ns.tprint(
      "INFO :    <pct> is the 1-based maximum percentage to hack from the target (Optional, default is 25%)"
    )
    ns.tprint("INFO :")
    ns.tprint("INFO : XP MODE: run v3.js xp")
    ns.tprint(
...
async function ExploitCallback(ns, server, pct, xpMode, result) {
